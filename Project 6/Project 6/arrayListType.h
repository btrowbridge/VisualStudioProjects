...
public:
	...
	void intervalInsertionSort(int begin, int inc, int& comparisons, int& movements);

	void shellSort(int& comparisons, int& movements);

	void heapSort(int& comparisons, int& movements);
...
protected:
	...
	void heapify(int low, int high, int& comparisons, int& movements);
};
...
template <class elemType>
void arrayListType<elemType>::insertionSort(int& comparisons, int& movements)
{
...
template <class elemType>
void arrayListType<elemType>::intervalInsertionSort(int begin, int inc, int& comparisons, int& movements)
{
	int firstOutOfOrder, location;
	elemType temp;

	for (firstOutOfOrder = begin; firstOutOfOrder < length;
		firstOutOfOrder += inc)
	{
		comparisons++;
...
template <class elemType>
void arrayListType<elemType>::shellSort(int& comparisons, int& movements)
{
	int inc;
	...
	do
	{
		...
		{
			intervalInsertionSort(begin, inc, comparisons, movements);
			inc = inc / 3;
		}
	} while (inc > 0);
...
template <class elemType>
void arrayListType<elemType>::heapify(int low, int high, int& comparisons, int& movements)
{
	int largeIndex;
...
template <class elemType>
void arrayListType<elemType>::heapSort(int& comparisons, int& movements)
{
	elemType temp;
	...
	{
		heapify(index, length - 1, comparisons, movements);
	}
		...
		lastOutOfOrder--)
	{
		...
		heapify(0, lastOutOfOrder - 1, comparisons, movements);
	}//end for 
